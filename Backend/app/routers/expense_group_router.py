...
# @expense_group_router.get("/{group_id}", response_model=list[ExpenseResponse])
...
# @expense_group_router.get("/{expense_id}", response_model=ExpenseResponse)
# def get_expense(
#     expense_id: int,
#     service: ExpenseService = Depends(get_expense_service),
#     current_user: User = Depends(get_current_active_user),
...
# @expense_group_router.post("/{group_id}", response_model=ExpenseResponse, status_code=status.HTTP_201_CREATED)
# def create_expense(
#     group_id: int,
...
# @expense_group_router.put("/{expense_id}", response_model=ExpenseResponse)
# def update_expense(
#     expense_id: int,
...
# @expense_group_router.delete("/{expense_id}", status_code=status.HTTP_204_NO_CONTENT)
# def delete_expense(
#     expense_id: int,
#     service: ExpenseService = Depends(get_expense_service),
#     current_user: User = Depends(get_current_active_user),
